...
const routes = [
  ...
  { path: '/employees', name: 'employees', component: EmployeesView, meta: { requiresAuth: true, roles: ['Admin', 'HR', 'Manager'] } },
  { path: '/employees/:id', name: 'employee-profile', component: DashboardView, meta: { requiresAuth: true, roles: ['Admin', 'HR', 'Manager'] } },
  { path: '/materials', name: 'materials', component: MaterialsView, meta: { requiresAuth: true, roles: ['Admin', 'Manager', 'HR', 'Employee'] } },
  { path: '/tests/import', name: 'test-import', component: TestImportView, meta: { requiresAuth: true, roles: ['Admin', 'HR'] } },
  { path: '/tests/create', name: 'test-create', component: TestCreateView, meta: { requiresAuth: true, roles: ['Admin', 'HR'] } },
  { path: '/tests/:id/edit', name: 'test-edit', component: TestCreateView, meta: { requiresAuth: true, roles: ['Admin', 'HR'] } },
